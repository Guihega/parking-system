<div class="parking-wrapper checkout-wrapper">
    <h3 class="checkout-title">Consulta de ticket</h3>
    <div class="glass-card token-search">
        <div class="token-field">
            ...
            <input
                ...
                autocomplete="off"
            >
            <button class="token-btn" onclick="consultTicket()">
                Consultar
            </button>
        </div>
    </div>
    <div class="checkout-grid">
        ...
        <div class="ticket-charge-grid">
            <div id="ticketCard" class="glass-card p-3 d-none">
                <h5>Ticket</h5>
            ...
            <div id="chargeCard" class="glass-card p-3 d-none">
                <h5>Cobro</h5>
            ...
            <!-- HISTORIAL -->
            <div id="historyCard" class="glass-card p-3 d-none mt-1 history-full">
        ...
        <div class="receipt-preview">
            <div id="receiptCard" class="receipt d-none">
...
<script>
    ...
    async function consultTicket(autoPrint = false) {
        ...
        try {
            ...
            if (ticket.status === 'open') {
                ...
                chargeCard.classList.remove('d-none');
    ...
    async function registerExit() {
        ...
        if (!confirm('¿Registrar pago y cerrar ticket?')) return;
    ...
    function showReprintButton(){
        document.getElementById('reprintBtn').classList.remove('d-none');
    }
    ...
    async function printThermalESC(r){
        try{
            ...
            alert('No se pudo imprimir en térmica');
        }
    }
    ...
    async function printReceipt(r){
        ...
        try{
            ...
            console.warn('Térmica no disponible, usando navegador');
            printReceiptClean(buildReceiptHTML(r));
        }
    }
    ...
    async function confirmPayment(){
        ...
        if(!confirm(`¿Confirmar pago con método: ${method}?`)) return;
